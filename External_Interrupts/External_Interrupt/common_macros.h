...
#define EX_INT1_ENABLE_BIT   			   7
#define EX_INT1_SENSE_CONTROL_10  		   2
#define EX_INT1_SENSE_CONTROL_11  		   3

#define EX_INT2_ENABLE_BIT   			   5
#define EX_INT2_SENSE_CONTROL  		   	   6
